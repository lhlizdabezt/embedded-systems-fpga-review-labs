...
This update keeps `embedded-systems-fpga-review-labs` aligned with the English-facing engineering portfolio while removing dash-line motion from SVG visuals.

## Changes

- Cleaned `assets/fpga-review-motion.svg` so SVG motion no longer uses moving dashed or dotted line effects.
